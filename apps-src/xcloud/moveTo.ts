...
//
// Taken from apps-src/mediaclient/moveTo.ts unchanged, because the measurement
// behind it is about this box rather than about that app: a scrolling container
// whose contents are being rebuilt costs the GPU process five times what the same
// distance costs as a composited transform. Kept as a copy rather than shared
// because each app package builds standalone.
//
